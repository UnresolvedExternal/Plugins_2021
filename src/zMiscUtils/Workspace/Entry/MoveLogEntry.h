namespace NAMESPACE
{
	...
	Hook<void(__fastcall*)(oCLogTopic*, zSTRING const&), ActiveOption<bool>> Ivk_oCLogTopic_AddEntry(ZENFOR(0x0072EA60, 0x0076D0B0, 0x0077A630, 0x00663870), &Hook_oCLogTopic_AddEntry, HookMode::Patch, Options::MoveLogEntry);
