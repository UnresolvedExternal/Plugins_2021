namespace NAMESPACE
{
	...
	Hook<int(__thiscall*)(oCItem*, int), ActiveOption<bool>> Ivk_oCItem_GetStateEffectFunc(ZENFOR(0x00672420, 0x0069FDE0, 0x006B4D80, 0x00712B80), &Hook_oCItem_GetStateEffectFunc, HookMode::Patch, Settings::FastFood);
