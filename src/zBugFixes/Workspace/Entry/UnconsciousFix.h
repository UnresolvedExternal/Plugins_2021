namespace NAMESPACE
{
	...
	Hook<void(__thiscall*)(oCNpc*, float, oCNpc*), ActiveOption<bool>> Ivk_oCNpc_DropUnconscious(ZENFOR(0x00692C10, 0x006C42F0, 0x006D7750, 0x00735EB0), &Hook_oCNpc_DropUnconscious, HookMode::Patch, Options::UnconsciousFix);
