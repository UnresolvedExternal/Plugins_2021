namespace NAMESPACE
{
	...
	Hook<int(__thiscall*)(oCNpc*, oCMsgWeapon*), ActiveOption<bool>> Ivk_oCNpc_EV_RemoveWeapon(ZENFOR(0x006A93C0, 0x006DC1B0, 0x006EEDB0, 0x0074DB20), &Hook_oCNpc_EV_RemoveWeapon, HookMode::Patch, Options::WaterWeaponFix);
