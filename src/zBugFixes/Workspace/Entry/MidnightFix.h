namespace NAMESPACE
{
	...
	Hook<void(__thiscall*)(oCGame*), ActiveOption<bool>> Ivk_oCGame_RefreshNpcs(ZENFOR(0x006409B0, 0x00667A70, 0x0066E870, 0x006CB5F0), &Hook_oCGame_RefreshNpcs, HookMode::Patch, Options::MidnightFix);
