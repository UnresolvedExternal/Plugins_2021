namespace NAMESPACE
{
	...
	Hook<oCItem*(__thiscall*)(oCNpc*, oCItem*), ActiveOption<bool>> Ivk_oCNpc_PutInInv(ZENFOR(0x006A4FF0, 0x006D7AC0, 0x006EA870, 0x00749350), &Hook_oCNpc_PutInInv, HookMode::Patch, Settings::PutInInvFix);
